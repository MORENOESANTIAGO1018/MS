-- bootstrap_local_auth_stub.sql
-- APENAS PARA TESTES LOCAIS NESTE AMBIENTE SANDBOX (sem Supabase CLI/Docker).
-- NUNCA rodar contra um projeto Supabase real. Ver README.md deste diretorio.
...
-- Emula exatamente a funcao que o Supabase expoe em qualquer projeto real:
